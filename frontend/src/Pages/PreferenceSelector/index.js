...
import { getBranchList, getCollegeList, getYearList } from "../../axios";
...
const PreferenceSelector = () => {
    ...
    async function onSubmitButton() {
        if (userData.college != null && userData.branch != null && userData.year != null) {
            await axiosInstance.put("/auth/profile/me/", userData);
        } else {
